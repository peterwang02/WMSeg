...
def cws_evaluate_word_PRF(y_pred, y, path):
    ...
    with open(path, "a") as out :
        out.write("F1-score: "+ str(F) + "\n")
    return P, R, F


def cws_evaluate_OOV(y_pred_list, y_list, sentence_list, word2id, path):
    cor_num = 0
    yt_wordnum = 0
